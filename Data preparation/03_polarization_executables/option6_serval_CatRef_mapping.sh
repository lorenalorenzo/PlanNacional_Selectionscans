...
INfastq_PATH=/mnt/netapp1/Store_csebdjgl/reference_genomes/lion_serval_polarization/SRR6071636
INfastqR1=($(ls $INfastq_PATH | grep "_1"))
INfastqR2=($(ls $INfastq_PATH | grep "_2"))
OUT=/mnt/netapp1/Store_csebdjgl/reference_genomes/lion_serval_polarization/SRR6071636
SAMPLE=(serval)
...
RGID=SRR6071636 RGLB=PSE16 \
RGPL=Illumina RGPU=SRS2538252 RGSM=${SAMPLE} \
