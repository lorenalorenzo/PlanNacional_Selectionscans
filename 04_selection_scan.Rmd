  ...
  do
    ...
    for chr in ${CHR[@]:0:19} 
      do
        ...
        ##AQUI##
        ./lassip --vcf $LUSTRE/selection_scan/${chr}_${sp}_goodsamples_filtered_phased_polarized_ACfiltered_header_cat_ref.vcf --calc-spec --hapstats --salti --winsize 101 --winstep 10 --pop /home/llorenzo/rehh_test/${sp}_ind.txt --out /home/llorenzo/rehh_test/${chr}
      done
